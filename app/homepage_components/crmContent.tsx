...
export default function CRMContent({Bebas, Roboto}: {Bebas: string, Roboto: string}) {
    ...
    return(
        <div className={`flex flex-col justify-center items-center px-2 pb-2 md:pb-6 bg-gradient-to-tr from-cyan-500 via-blue-500 to-teal-200 h-auto w-full h-auto ${Roboto}`}>
            <div className='flex flex-col md:flex-row max-w-7xl bg-neutral-800 p-10 md:p-20 rounded-md bg-opacity-[30%] justify-center items-center mt-2 md:mt-6'>
                ...
                <p className={`${Bebas} mt-6 md:mt-0 text-6xl text-center md:text-left md:text-8xl w-full md:w-1/2 text-white flex justify-center items-center`}>Certified Salesforce Administrator</p>
            </div>
            <div className='flex flex-col max-w-7xl w-full bg-neutral-800 md:p-6 rounded-md bg-opacity-[30%] mt-2 md:mt-6 justify-center'>
            ...
            <div className='flex flex-col max-w-7xl w-full bg-neutral-800 p-6 md:p-20 rounded-md bg-opacity-[30%] mt-2 md:mt-6 justify-center'>
