    ...
    <form onSubmit={(e) => formHandler(e)}>
        <div className="bg-neutral-800 bg-opacity-[40%] shadow-inner relative rounded-[4px] rounded-tl-[0px] p-6">
            <div className="">
                ...
                <input onChange={(e) => updateFormData(e, 'name')} value={FormData.name} required type='text' placeholder='John Smith' className={`${Roboto} focus:shadow-inner pl-3 text-3xl text-zinc-800 bg-zinc-100 w-[30rem] focus:outline-none h-16 rounded-[4px]`} />
                <p className={`${Roboto1} mb-1 text-white drop-shadow-sm text-xl pl-2 mt-4`}>Email</p>
                <input onChange={(e) => updateFormData(e, 'email')} value={FormData.email} required type='email' placeholder='john.smith@acme.com' className={`${Roboto} focus:shadow-inner pl-3 text-3xl text-zinc-800 bg-zinc-100 w-[40rem] focus:outline-none h-16 rounded-[4px]`} />
                <p className={`${Roboto1} mb-1 text-white drop-shadow-sm text-xl pl-2 mt-4`}>Company <span className="text-sm">(optional)</span></p>
                <input onChange={(e) => updateFormData(e, 'company')} value={FormData.company} type='text' placeholder='ACME Tech Solutions' className={`${Roboto} focus:shadow-inner pl-3 text-3xl text-zinc-800 bg-zinc-100 w-[40rem] focus:outline-none h-16 rounded-[4px] mb-2`} />
            </div>
        </div>
        ...
        <div className="bg-neutral-800 bg-opacity-[40%] shadow-inner relative rounded-[4px] rounded-tl-[0px] p-6">
            <div className="">
                <textarea onChange={(e) => updateFormData(e, 'message')} value={FormData.message} required placeholder='Your portfolio site is sick!' className={`h-60 w-full resize-none focus:outline-none rounded-[4px] focus:shadow-inner p-5 text-3xl text-zinc-800 bg-zinc-100 ${Roboto}`} />
            </div>
        </div>
